...
* Installing the {registry} backend
...
* Installing the {registry} frontend
...
//INCLUDES
include::{mod-loc}getting-started/proc-installing-registry-in-memory-storage.adoc[leveloffset=+2]
include::{mod-loc}getting-started/proc-installing-registry-sql-storage.adoc[leveloffset=+2]
include::{mod-loc}getting-started/proc-installing-registry-kafka-storage.adoc[leveloffset=+2]
include::{mod-loc}getting-started/proc-installing-registry-frontend.adoc[leveloffset=+1]
